...
def start() -> None:
    ...
    if has_image_extension(roop.globals.target_path):
        ...
        print(
            f"======shutil.copy2(roop.globals.target_path, roop.globals.output_path):{shutil.copy2(roop.globals.target_path, roop.globals.output_path)}"
        )
        # process frame
        for frame_processor in get_frame_processors_modules(
            roop.globals.frame_processors
        ):
            print(f"======frame_processor:{frame_processor}")
            update_status("Progressing...", frame_processor.NAME)
            print(f"======frame_processor.process_image")
            frame_processor.process_image(
                roop.globals.source_path,
                roop.globals.output_path,
                roop.globals.output_path,
            )
            print(f"======frame_processor.post_process()")
    ...
    if roop.globals.skip_audio:
        print(f"======roop.globals.target_path:{roop.globals.target_path}")
        print(f"======roop.globals.output_path:{roop.globals.output_path}")
